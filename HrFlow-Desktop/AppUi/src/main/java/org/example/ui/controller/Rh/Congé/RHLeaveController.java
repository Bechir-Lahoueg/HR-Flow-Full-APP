...
public class RHLeaveController {
    ...
    // ─── Cartes blanches (grandes) ───────────────────────────────────────────────
    @FXML private Label totalRequestsCardLabel;
    @FXML private Label pendingRequestsCardLabel;
    @FXML private Label approvedRequestsCardLabel;
    @FXML private Label rejectedRequestsCardLabel;
    ...
    public void initData(int rhId, User rhUser) {
        ...
        // Les statistiques sont mises à jour automatiquement après chargement des données
    }
    ...
    private void updateStatistics() {
        ...
        if (totalRequestsLabel    != null) totalRequestsLabel.setText(String.valueOf(total));
        if (pendingRequestsLabel  != null) pendingRequestsLabel.setText(String.valueOf(pending));
        if (approvedRequestsLabel != null) approvedRequestsLabel.setText(String.valueOf(approved));
        if (rejectedRequestsLabel != null) rejectedRequestsLabel.setText(String.valueOf(rejected));

        if (totalRequestsCardLabel    != null) totalRequestsCardLabel.setText(String.valueOf(total));
        if (pendingRequestsCardLabel  != null) pendingRequestsCardLabel.setText(String.valueOf(pending));
        if (approvedRequestsCardLabel != null) approvedRequestsCardLabel.setText(String.valueOf(approved));
        if (rejectedRequestsCardLabel != null) rejectedRequestsCardLabel.setText(String.valueOf(rejected));
    }
