...
public class PublicHolidayService {
    ...
    // Cache statique partagé entre toutes les instances : clé = "YYYY_CC" → liste de jours fériés
    private static final Map<String, List<HolidayEntry>> cache = new ConcurrentHashMap<>();
